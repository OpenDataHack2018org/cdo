...
static int
isSorted(size_t *restrict array1, size_t *restrict array2, const size_t size)
{
...
static
void heapify(const long pos, const long size, int *restrict arr1, int *restrict
arr2, int *restrict arr3)
{
...
/*
static
void remap_heapsort_recursiv(const long num_links, int *restrict arr1, int
*restrict arr2, int *restrict arr3)
{
         ...
         int parent, int par_depth)
{
  /*
    This routine is the core of merge-sort. It does the following
     ...
     Parameters:
     -----------
       long num_links    | length of arrays add1 and add2 (MUST be of same
