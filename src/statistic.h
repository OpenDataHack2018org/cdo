...
void eigen_solution_of_symmetric_matrix(double **a, double *eig_val, int n,
                                        const char *prompt);
...
void ft_r(double *restrict real, double *restrict imag, int n, int sign,
...
// EOF3d.c
void parallel_eigen_solution_of_symmetric_matrix(double **M, double *A, int n,
                                                 const char func[]);
