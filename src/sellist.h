...
#define SELLIST_ADD_INT(name, txt) \
  SELLIST_DEF_INT(name);           \
  int idx_##name = sellist_add(sellist, txt, #name, SELLIST_INT)
#define SELLIST_ADD_FLT(name, txt) \
  SELLIST_DEF_FLT(name);           \
  int idx_##name = sellist_add(sellist, txt, #name, SELLIST_FLT)
#define SELLIST_ADD_WORD(name, txt) \
  SELLIST_DEF_WORD(name);           \
  int idx_##name = sellist_add(sellist, txt, #name, SELLIST_WORD)
...
#define SELLIST_CHECK_SEASON(name, month) \
  sellist_check_season(sellist, idx_##name, month)
#define SELLIST_DEF_FLAG(name, vindex, flag) \
  sellist_def_flag(sellist, idx_##name, vindex, flag)
#define SELLIST_GET_VAL(name, vindex, val) \
  sellist_get_val(sellist, idx_##name, vindex, val)
#define SELLIST_DEF_VAL(name, vindex, val) \
  sellist_def_val(sellist, idx_##name, vindex, val)

sellist_t *sellist_create(list_t *kvlist);
void sellist_destroy(sellist_t *sellist);
void sellist_verify(sellist_t *sellist);
int sellist_add(sellist_t *sellist, const char *txt, const char *name,
                int type);
