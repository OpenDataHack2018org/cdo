...
int Pthread_create(const char *caller, pthread_t *th, pthread_attr_t *attr,
...
void Pthread_cond_signal(const char *caller,
                         std::condition_variable &p_cond_var);
void Pthread_cond_wait(const char *caller, pthread_cond_t *cond,
                       pthread_mutex_t *mutex);
void Pthread_cond_wait(const char *caller, std::condition_variable &p_cond_var,
