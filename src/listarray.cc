...
static void
listaInit(lista_t *lista, int type)
{
  lista->array = NULL;
  lista->nalloc = 0;
...
void *
lista_dataptr(lista_t *lista)
{
  return lista->array;
}

static void
listaCheck(lista_t *lista, int num)
{
...
void
lista_set_int(lista_t *lista, int num, int ival)
{
...
void
lista_set_flt(lista_t *lista, int num, double fval)
{
  listaCheck(lista, num);
...
int
lista_get_int(lista_t *lista, int num)
{
...
double
lista_get_flt(lista_t *lista, int num)
{
...
int
args2int_lista(int argc, char **argv, lista_t *lista)
{
  int nint = 0;
  int ival;
  int first, last, inc;
...
int
args2flt_lista(int argc, char **argv, lista_t *lista)
{
  int i, nint = 0;
  int ival;
  int first, last, inc;
