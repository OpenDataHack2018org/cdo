...
static char *SplitHelp[] = {
    ...
    "                Splits a dataset into pieces, one for each different variable name.",
...
static char *SelectHelp[] = {
    ...
    "    Which fields are selected depends on the operator name and the parameters.",
    "",
    "OPERATORS",
...
static char *SeltimeHelp[] = {
    ...
    "    Which time steps are selected depends on the operator name and the parameters.",
    "",
    "OPERATORS",
...
static char *InvertHelp[] = {
    ...
    "",
    "DESCRIPTION",
    "    This module inverts 2D fields on a regular longitude/latitude grid.",
    "    Depending on the actual operator name the lon/lat field, only the data",
    "    or only the grid description is inverted.",
    "",
    "OPERATORS",
...
static char *EnlargeHelp[] = {
    ...
    "    Zonal enlargement takes place, if the xsize of the input",
    "    field is 1 and the ysize of both grids are the same.",
...
static char *MathHelp[] = {
    "NAME",
    "    abs, sqr, sqrt, exp, log, log10, sin, cos, tan, asin, acos, atan - ",
