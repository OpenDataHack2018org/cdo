...
static const char *SelectHelp[] = {
    ...
    "    grid              INTEGER Comma separated list of grid numbers.",
...
static const char *MagvectorHelp[] = {
    ...
    "    components. The result is written to ofile. The default output file format is postscript,",
    "    this can be changed with the device parameter.",
    "    ",
...
static const char *MaggraphHelp[] = {
    ...
    "    The result is written to ofile. The default output file format is postscript, this can be changed with the device parameter.",
    "    ",
    "    Here is a list of all common plot parameters:",
    "    ",
    "     Keyname    & Type    & Description      ",
