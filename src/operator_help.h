...
static char *EOFsHelp[] = {
    "NAME",
    "    eof, eoftime, eofspatial, eof3d, eof3time - Empirical Orthogonal Functions",
    "",
    "SYNOPSIS",
    "    eof,neof  ifile ofile1 ofile2",
    "    eoftime,neof  ifile ofile1 ofile2",
    "    eofspatial,neof  ifile ofile1 ofile2",
    "    eof3d,neof  ifile ofile1 ofile2",
    "    eof3time  ifile ofile1 ofile2",
    "",
    "DESCRIPTION",
