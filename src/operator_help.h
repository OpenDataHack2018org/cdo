...
static const char *ExprHelp[] = {
    ...
    "    ",
    "    The following coordinate functions are available:",
    "    ",
    ...
    "    ",
    "    The following CDO functions are available:",
    "    ",
    "    fldmin, fldmax, fldsum, fldmean, fldavg, fldstd, fldstd1, fldvar, fldvar1, ",
    "    vertmin, vertmax, vertsum, vertmean, vertavg, vertstd, vertstd1, vertvar, vertvar1",
    "    ",
    "",
    "OPERATORS",
