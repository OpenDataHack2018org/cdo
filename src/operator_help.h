...
static char *EOFsHelp[] = {
    ...
    "    Data in ifile are assumed to be anomalies. If they are not, the behavior ",
    "    of this module is not well defined. ",
    ...
    "",
    "OPERATORS",
    "    eof         Calculate neof EOFs in spatial or time space",
    "    eoftime     Calculate neof EOFs in time space",
