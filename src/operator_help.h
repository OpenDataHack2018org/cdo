...
static char *SinfoHelp[] = {
    ...
    "    standard output. The information displayed depends on the actual operator name.",
    "",
    "OPERATORS",
    "    sinfo   Short dataset information",
    "            Prints short information of a dataset. The information is divided into",
    "            4 sections. Section 1 prints for each variable in one line the:",
...
static char *SelectHelp[] = {
    ...
    "",
    "DESCRIPTION",
    "    This module selects some fields from ifile and write the result to ofile.",
    "    Which fields are selected depends on the actual operator name and the parameters.",
    "",
    "OPERATORS",
    "    selcode       Select codes",
    "                  Selects all fields with a code number in a user given list.",
    "    delcode       Delete codes",
    "                  Deletes all fields with a code number in a user given list.",
    ...
    "                  Selects all fields with a parameter table number in a user given list.",
...
static char *SeltimeHelp[] = {
    ...
    "",
    "DESCRIPTION",
    "    This module selects some time steps from ifile and write the result to ofile.",
    "    Which time steps are selected depends on the actual operator name and the parameters.",
    "",
    "OPERATORS",
...
static char *SetHelp[] = {
    ...
    "    operator name the parameter table, code number, variable name or",
    "    level is set.",
    "",
    "OPERATORS",
...
static char *SettimeHelp[] = {
    ...
    "    time axis is overwritten depends on the actual operator name.",
    "",
    "OPERATORS",
    "    setdate      Set date",
...
static char *SetgattHelp[] = {
    ...
    "",
    "DESCRIPTION",
    "    This module sets global text attributes of a dataset.",
    "    Depending on the actual operator name the attributes",
    "    are read from a file or can be specified by parameter.",
    "",
    "OPERATORS",
...
static char *EnlargeHelp[] = {
    ...
    "    feld element is used for the enlargement. If however the input and output",
...
static char *Cond2Help[] = {
    "NAME",
    "    ifthenelse - Condition with tree fields",
    "",
    "SYNOPSIS",
    "    ifthenelse  ifile1 ifile2 ifile3 ofile",
    "",
    "DESCRIPTION",
    "    This operator conditional selects fields from ifile2 or ifile3 and writes the result to ofile.",
    "    A value not equal to zero is treated as \"true\", zero is treated as \"false\".",
    "              / i_2(t,x) if i_1(t,x) NE 0  AND  i_1(t,x) NE miss",
...
static char *CondcHelp[] = {
    "NAME",
    "    ifthenc, ifnotthenc - Condition with a field and a constant",
    "",
    "SYNOPSIS",
    "    <operator>,c  ifile ofile",
    "",
...
static char *ZonstatHelp[] = {
    ...
    "    According to the actual operator name the zonal minimum, maximum, ",
    "    sum, average, standard deviation or variance is written to ofile.",
...
static char *MerstatHelp[] = {
    ...
    "    According to the actual operator name the meridional minimum, maximum,",
    "    sum, average, standard deviation or variance is written to ofile.",
    "    All input fields must have the same rectangular grid. ",
    "",
    "OPERATORS",
...
static char *VertstatHelp[] = {
    ...
    "    According to actual operator name the vertical minimum, maximum, sum, average, ",
...
static char *SelstatHelp[] = {
    ...
    "    According to the actual operator name the average, minimum, maximum, sum, average ",
...
static char *SeasstatHelp[] = {
    ...
    "    the last output timestep, they may be incorrect DJF values.",
    "",
    "OPERATORS",
...
static char *YdaystatHelp[] = {
    ...
    "",
    "DESCRIPTION",
    "    This module writes to ofile, according to the actual operator name,",
...
static char *GenweightsHelp[] = {
    "NAME",
    "    genbil, genbic, gencon, gendis - SCRIP grid interpolation weights",
    "",
    "SYNOPSIS",
    "    <operator>,grid  ifile ofile",
    "",
...
static char *OutputHelp[] = {
    ...
    "    All input fields must have the same horizontal grid.",
    "    The format of the output depends on the actual operator name.",
    "",
    "OPERATORS",
    "    output     ASCII output",
...
static char *VargenHelp[] = {
    ...
    "    According to  the actual operator name all field elements",
    ...
    "            have the same value.",
    "    random  Field with random values",
...
static char *RotuvHelp[] = {
    ...
    "",
    "DESCRIPTION",
    "    This is a special operator for datsets with wind components",
    "    on an rotated grid, e.g. data from the regional model REMO.",
    "    It performs a backward transformation of velocity",
