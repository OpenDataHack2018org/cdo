...
static char *SetpartabHelp[] = {
    ...
    "    This is typically used for netCDF datasets. The operator setpartab searches variables by the code number.",
    "",
    "OPERATORS",
    "    setpartab   Set parameter table",
    "                Search variables by code number.",
...
static char *SetHelp[] = {
    "NAME",
    "    setcode, setparam, setname, setunit, setlevel, setltype - Set field info",
    "",
    "SYNOPSIS",
