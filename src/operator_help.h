...
static char *ShowinfoHelp[] = {
    ...
    "DESCRIPTION",
    "    This module prints, according to the actual operator,",
    "    the format, variables, levels or times of the input dataset.",
    "",
    "OPERATORS",
    ...
    "                 Prints the GRIB level type for all different z-axis.",
    "    showyear     Show years",
...
static char *EnsstatHelp[] = {
    ...
    "    to ofile. The date information for a time step in ofile is",
...
static char *ZonstatHelp[] = {
    ...
    "    sum, average, variance, standard deviation or a certain percentile",
    "    is written to ofile. All input fields must have the same",
    "    rectangular grid. ",
    "",
    "OPERATORS",
...
static char *MerstatHelp[] = {
    ...
    "    written to ofile. All input fields must have the same rectangular",
    "    grid. ",
    "",
    "OPERATORS",
...
static char *TimselpctlHelp[] = {
    ...
    "    ifile2 and ifile3 must be the result of corresponding",
...
static char *TimpctlHelp[] = {
    ...
    "",
    "DESCRIPTION",
    "    This module computes percentiles over all time steps in ifile1.",
    "    The algorithm uses histograms with minimum and maximum bounds given in",
    "    ifile2 and ifile3, respectively. The default number of",
    "    histogram bins is 100. The default can be overridden by setting the",
    "    environment variable CDO_PCTL_NBINS to a different value. The files",
...
static char *DaypctlHelp[] = {
    ...
    "    ifile3 must be the result of corresponding daymin and daymax",
...
static char *YhourstatHelp[] = {
    ...
    "    hour and day of year in ifile. The date information in an output field is ",
...
static char *YdaypctlHelp[] = {
    ...
    "",
    "DESCRIPTION",
    "    This module writes to ofile a certain percentile of each day of",
    "    year in ifile1.",
    "    The algorithm uses histograms with minimum and maximum bounds given in",
    "    ifile2 and ifile3, respectively. The default number of",
    "    histogram bins is 100. The default can be overridden by setting the",
...
static char *YmonpctlHelp[] = {
    ...
    "",
    "DESCRIPTION",
    "    This module writes to ofile a certain percentile of each month",
    "    of year in ifile1.",
    "    The algorithm uses histograms with minimum and maximum bounds given in",
    "    ifile2 and ifile3, respectively. The default number of",
    "    histogram bins is 100. The default can be overridden by setting the",
...
static char *YseaspctlHelp[] = {
    ...
    "",
    "DESCRIPTION",
    "    This module writes to ofile a certain percentile of each season",
    "    in ifile1.",
    "    The algorithm uses histograms with minimum and maximum bounds given in",
    "    ifile2 and ifile3, respectively. The default number of",
    "    histogram bins is 100. The default can be overridden by setting the",
...
static char *YdrunstatHelp[] = {
    ...
    "    day of year in ifile. Depending on the actual operator, the minimum,",
    ...
    "    Note that the operator must be applied to a continuous time series of daily",
...
static char *YdrunpctlHelp[] = {
    ...
    "    day of year in ifile1. A certain percentile is computed for all",
...
static char *WctHelp[] = {
    ...
    "    calculation is only valid for a temperature of T <= 33Â° C and a wind speed",
    ...
    "    must be given in units of Â°C and m/s, respectively.",
    NULL
};
...
static char *StrwinHelp[] = {
    ...
    "    speed greater than or equal to v. Note that both VX and v must be given in",
...
static char *StrbreHelp[] = {
    ...
    "    meridional wind speeds and must be given in units of m/s.",
    "    The date information for a time step in ofile is the date of",
    "    the last contributing time step in ifile.",
    NULL
};
...
static char *EcaGslHelp[] = {
    ...
    "PARAMETER",
    "    nday   INTEGER  Number of consecutive days (default: nday = 6)",
    "    T      DOUBLE   Temperature threshold (° Celsius, default: T = 5° Celsius)",
...
static char *EcaSuHelp[] = {
    ...
    "    must be given in units of Kelvin, whereas T must be given in degrees Celsius.",
    "    The date information for a time step in ofile is the date of",
    "    the last contributing time step in ifile.",
    "",
    "PARAMETER",
