...
static const char *TimselstatHelp[] = {
    ...
    "    The time of ofile is determined by the time in the middle of all contributing timesteps of ifile.",
    "",
    "OPERATORS",
...
static const char *TimselpctlHelp[] = {
    ...
    "    The time of ofile is determined by the time in the middle of all contributing timesteps of ifile1.",
    "    For every adjacent sequence t1, ...., tn of timesteps of the same selected time range it is:",
    "    ",
...
static const char *TimpctlHelp[] = {
    ...
    "    environment variable CDO_PCTL_NBINS. The files ifile2 and ifile3 should be",
...
static const char *HourpctlHelp[] = {
    ...
    "    ifile3, respectively. The default number of histogram bins is 101.",
    "    The default can be overridden by defining the environment variable CDO_PCTL_NBINS.",
    "    The files ifile2 and ifile3 should be the result of corresponding hourmin",
...
static const char *DaypctlHelp[] = {
    ...
    "    ifile3, respectively. The default number of histogram bins is 101.",
    "    The default can be overridden by defining the environment variable CDO_PCTL_NBINS.",
    "    The files ifile2 and ifile3 should be the result of corresponding daymin",
...
static const char *MonpctlHelp[] = {
    ...
    "    ifile3, respectively. The default number of histogram bins is 101.",
    "    The default can be overridden by defining the environment variable CDO_PCTL_NBINS.",
    "    The files ifile2 and ifile3 should be the result of corresponding monmin",
...
static const char *YearpctlHelp[] = {
    ...
    "    overridden by defining the environment variable CDO_PCTL_NBINS. The files ifile2 and",
    "    ifile3 should be the result of corresponding yearmin and yearmax operations, respectively.",
    "    The time of ofile is determined by the time in the middle of all contributing timesteps of ifile1.",
    "    For every adjacent sequence t_1, ...,t_n of timesteps of the same year it is:",
    "    ",
    "    o(t,x) = pth percentile {i(t',x), t_1<t'<=t_n}",
...
static const char *SeaspctlHelp[] = {
    ...
    "    by defining the environment variable CDO_PCTL_NBINS. The files ifile2 and ifile3",
...
static const char *CMORliteHelp[] = {
    ...
    "",
    "SYNOPSIS",
    "    cmorlite,table[,convert]  ifile ofile",
    "",
    "DESCRIPTION",
