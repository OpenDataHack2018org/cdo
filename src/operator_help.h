...
static char *ShowinfoHelp[] = {
    "NAME",
    "    showformat, showcode, showvar, showstdname, showlevel, showltype, showyear, ",
...
static char *SelectHelp[] = {
    "NAME",
    "    selcode, delcode, selvar, delvar, selstdname, sellevel, selltype, selgrid, ",
    "    selgridname, selzaxis, selzaxisname, seltabnum, selrec - Select fields",
    "",
    "SYNOPSIS",
...
static char *SelstatHelp[] = {
    "NAME",
    "    selmin, selmax, selsum, selmean, selavg, selvar, selstd - ",
