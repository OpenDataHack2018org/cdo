...
static char *MaskregionHelp[] = {
    ...
    "    input fields need to have the same horizontal grid.",
...
static char *GenweightsHelp[] = {
    ...
    "    weights can be reused for every remapping process with the operator remap. ",
...
static char *IntgridHelp[] = {
    ...
    "                 is faster than remapbil. The complete target grid have to be inside",
