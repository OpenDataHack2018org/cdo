...
static char *EnlargeHelp[] = {
    ...
    "    have to be 1 and the xsize of both grids must have the same size.",
    "",
    "PARAMETER",
    "    grid  STRING  Target grid description file or name",
    NULL
...
static char *TimselstatHelp[] = {
    ...
    "    According to the actual operator the minimum, maximum, sum, average,",
...
static char *HourpctlHelp[] = {
    ...
    "",
    "DESCRIPTION",
    "    This module computes percentiles over all time steps of the same hour in ifile1.",
    "    The algorithm uses histograms with minimum and maximum bounds given in",
    "    ifile2 and ifile3, respectively. The default number of",
    "    histogram bins is 100. The default can be overridden by setting the",
    "    environment variable CDO_PCTL_NBINS to a different value. The files",
...
static char *DaypctlHelp[] = {
    ...
    "",
    "DESCRIPTION",
    "    This module computes percentiles over all time steps of the same day in ifile1.",
    "    The algorithm uses histograms with minimum and maximum bounds given in",
    "    ifile2 and ifile3, respectively. The default number of",
...
static char *MonpctlHelp[] = {
    ...
    "",
    "DESCRIPTION",
    "    This module computes percentiles over all time steps of the same month in ifile1.",
    "    The algorithm uses histograms with minimum and maximum bounds given in",
    "    ifile2 and ifile3, respectively. The default number of",
    "    histogram bins is 100. The default can be overridden by setting the",
    "    environment variable CDO_PCTL_NBINS to a different value. The files",
...
static char *YearpctlHelp[] = {
    ...
    "",
    "DESCRIPTION",
    "    This module computes percentiles over all time steps of the same year in ifile1.",
    "    The algorithm uses histograms with minimum and maximum bounds given in",
    "    ifile2 and ifile3, respectively. The default number of",
    "    histogram bins is 100. The default can be overridden by setting the",
    "    environment variable CDO_PCTL_NBINS to a different value. The files",
...
static char *IntgridHelp[] = {
    ...
    "                 is faster than remapbil. The complete source grid have to be inside",
...
static char *WctHelp[] = {
    ...
    "    have to be given in units of Â°C and m/s, respectively.",
    NULL
};
