...
static char *SetgattHelp[] = {
    ...
    "    operator name the attributes are read from a file or can be specified by parameter.",
    "",
    "OPERATORS",
...
static char *IntgridHelp[] = {
    ...
    "                 This is the PINGO grid interpolation.",
...
static char *SpectralHelp[] = {
    ...
    "",
    "DESCRIPTION",
    "    This module transforms fields on gaussian grids to spectral",
...
static char *WindHelp[] = {
    ...
    "",
    "DESCRIPTION",
    "    This module converts divergence and vorticity to U and V wind and back.",
    "",
    "OPERATORS",
...
static char *OutputHelp[] = {
    ...
    "    All input fields must have the same horizontal grid. The format of the ",
    "    output depends on the actual operator name.",
    "",
    "OPERATORS",
    "    output     ASCII output",
...
static char *VargenHelp[] = {
    ...
    "            have the same value.",
    "    random  Create field with random values",
