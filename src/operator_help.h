...
static char *Ensstat2Help[] = {
    ...
    "    ofile. The date information of a time step in ofile is the date of the ",
    "    first input file.",
    "    ",
    "    All Operators in this module use ifile1 as the reference (for instance ",
    "    an observation) whereas files ifile2 - ifilen are understood as ",
    "    an ensemble consisting of n-1 members. ",
    "    ",
    "    For the Brier score it is assumed, that both obsfile and ifiles ",
    "    contain probability information. Usually in a way that obsfile is a ",
    "    mask indicating the occurence of an event and ifiles are forecast ",
