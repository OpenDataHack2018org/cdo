...
\item HDF5 \href{http://hdf.ncsa.uiuc.edu/doc_resource/SZIP}{szip} library
      ({\tt http://hdf.ncsa.uiuc.edu/doc\_resource/SZIP})
...
The netCDF-4 configuration depends on the netCDF-4 installation!
You have to set all additional libraries with the environment variable LIBS, e.g.:
 
\begin{verbatim}
    ./configure --with-netcdf=<netCDF-4 root directory>  LIBS='-lhdf5 -lz'
\end{verbatim}
