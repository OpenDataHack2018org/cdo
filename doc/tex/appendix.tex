...
CDO\_FILE\_SUFFIX             &   None   &  Set the default file suffix. This suffix will be added to the output file \\
                                           &               &  names instead of the filename extension derived from the file format. \\
                                           &               & Set this variable to NULL to disable the adding of a file suffix. \\ \hline
CDO\_PCTL\_NBINS            &     101    & Sets the number of histogram bins \\ \hline
