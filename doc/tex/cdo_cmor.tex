...
\begin{titlepage}
\vspace*{50mm}
{\Huge\textbf{The CDO CMOR operator}}
...
\end{picture}
\begin{flushright}
\large\textbf{Produce CMIP-compliant climate model output \\ April 2017}
\end{flushright}

\vfill

\Large\textbf{Fabian Wachsmann, Stephanie Legutke, Joerg Wegner}
