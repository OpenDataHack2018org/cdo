...
\item Horizontal interpolation (operator: \htmlref{interpolate}{interpolate}, \htmlref{remap*}{INTERPOLATE} and \htmlref{gen*}{GENWEIGHTS})
\item Generating variables (operator: \htmlref{const}{const}, \htmlref{random}{random})
\end{itemize}

There are several possibilities to define a horizontal grid. Predefined grids are available
for global regular, gaussian or icosahedral grids.
...
in \htmlref{Appendix A}{appendixa}.
