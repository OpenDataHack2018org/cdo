...
\makebox[1.5in][l]{\hspace*{1cm}\sl -p $<$prec$>$}
         \> Set the precision of the output data in bytes. The valid precisions \\
         ...
         \> For {\tt srv}, {\tt ext} and {\tt ieg} format a {\tt L} or {\tt B} can be added \\
         \> to set the byteorder to Little or Big endian. \\
