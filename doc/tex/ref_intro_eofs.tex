...
are called \textit{empirical orthogonal functions (EOFs) of the sample \(z\)}. (Please note, that \(e_j\) 
...
\end{displaymath}
where \(a_j\) are called the \textit{principal components} or \textit{principal coefficients} or 
\textit{EOF coefficients} of \(z\). These coefficients - as readily seen from above - 
